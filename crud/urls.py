...
from .views import (classroom_view, add_classroom_view,update_classroom_view,delete_classroom_view,
                    student_view,update_student_view,add_student_view,student_profile_view,
                    add_student_profile_view,student_profile_detail_view,UserloginView,user_logout_view)
...
urlpatterns = [
    ...
    path("update-classroom/<int:id>", update_classroom_view, name="update_classroom"),
     ...
     path("student-profile-details/<int:id>/",student_profile_detail_view, name="student_profile_detail"),
